...
public class DataGenerator {
        ...
        private static final String[] ENG_TITLES = { "Midnight Sky", "Ocean Eyes", "Blinding Lights", "Levitating",
                        "Peaches", "Stay", "Bad Habits", "Flowers", "Starboy", "Creepin", "Anti-Hero", "Cruel Summer",
                        "Vampire",
                        "Paint The Town Red", "Houdini", "Greedy", "Lovin On Me", "Water", "Agora Hills",
                        "Rich Baby Daddy" };
        private static final String[] ENG_ARTISTS = { "The Weeknd", "Dua Lipa", "Justin Bieber", "Miley Cyrus",
                        "Taylor Swift", "Post Malone", "Doja Cat", "Olivia Rodrigo", "Jack Harlow", "Tyla" };

        private static final String[] HIN_TITLES = { "Chaleya", "Tum Kya Mile", "Satranga", "Lutt Putt Gaya",
                        "Pehle Bhi Main", "Arjan Vailly", "Heeriye", "Jhoome Jo Pathaan", "Besharam Rang",
                        "Tere Vaaste",
                        "Dil Jhoom", "O Maahi", "Sajni", "Naina", "Tauba Tauba", "Aaj Ki Raat", "Akhiyaan Gulaab",
                        "Soni Soni",
                        "Tainu Khabar Nahi", "Vidaamuyarchi" };
        private static final String[] HIN_ARTISTS = { "Arijit Singh", "Shreya Ghoshal", "Vishal Mishra",
                        "Diljit Dosanjh",
                        "Neeti Mohan", "Badshah", "Karan Aujla", "Javed Ali", "Sunidhi Chauhan", "B Praak" };

        private static final String[] TEL_TITLES = { "Kurchi Madathapetti", "Chuttamalle", "Fear Song",
                        "Bhairava Anthem",
                        "Naa Ready", "Hukum", "Kaavaalaa", "Poonakaalu Loading", "Jai Balayya", "Ammaadi", "Jaragandi",
                        "Souraa",
                        "Dum Masala", "Mastaaru Mastaaru", "Srivalli", "Saami Saami", "Oo Antava",
                        "Eyy Bidda Idhi Naa Adda",
                        "Bulletto Bandekki", "Ramuloo Ramulaa" };
        private static final String[] TEL_ARTISTS = { "Anirudh Ravichander", "Sid Sriram", "Thaman S",
                        "Devi Sri Prasad",
                        "Shilpa Rao", "Rahul Sipligunj", "Anurag Kulkarni", "Mangli", "Ram Miriyala",
                        "Geetha Madhuri" };

        private static final String[] KAN_TITLES = { "Dwapara", "Jeeva Neene", "Chinnamma", "Hey Gagana",
                        "Kavithe Kavithe",
                        "Dheera Dheera", "Salaam Rocky Bhai", "Mehabooba", "Sulthana", "Belageddu", "Hands Up",
                        "Singara Siriye",
                        "Pasandaagavne", "Yenammi Yenammi", "Open Hairu", "Tunturu", "Usire Usire", "Kariya I Love You",
                        "Nooraaru Kalaga", "Sanju Weds Geetha" };
        private static final String[] KAN_ARTISTS = { "Vijay Prakash", "Sonu Nigam", "Sanjith Hegde", "Arjun Janya",
                        "Chandan Shetty", "All Ok", "Ananya Bhat", "Shreya Ghoshal", "Rajesh Krishnan",
                        "Anuradha Bhat" };

        private static final String[] GENRES = { "Pop", "Rock", "Classical", "Folk", "EDM", "Jazz", "Hip-Hop", "Soul",
                        "R&B", "Melody" };

        private static final String[][] FEATURED_SONGS = {
                        { "Manmohini", "Arijit Singh Remix", "Hindi",
                                        "https://files.freemusicarchive.org/storage-freemusicarchive-org/music/no_curator/Tours/Enthusiast/Tours_-_01_-_Enthusiast.mp3",
                                        "200", "Indian Melody" },
                        { "Kodagina Kaveri", "Vijay Prakash Classic", "Kannada",
                                        ...
                                        "180", "Folk" },
                        { "Telusa Telusa", "Sid Sriram Soul", "Telugu",
                                        ...
                                        "210", "Romantic" },
                        { "Midnight City", "Urban Beat", "English",
                                        "https://files.freemusicarchive.org/storage-freemusicarchive-org/music/no_curator/Scott_Holmes/Inspiring__Upbeat_Music/Scott_Holmes_-_04_-_Upbeat_Party.mp3",
                                        "190", "Synthwave" },
                        { "Ghananam Ghananam", "Carnatic Fusion", "Telugu",
                        ...
                        { "Sajni Re", "Lo-fi Mix", "Hindi",
                                        ...
                                        "160", "Lo-fi" },
                        { "Malnad Days", "Nature Flute", "Kannada",
                                        ...
                                        "175", "Instrumental" },
                        { "Skyline", "Electric Dreams", "English",
                                        "https://files.freemusicarchive.org/storage-freemusicarchive-org/music/no_curator/Tours/Enthusiast/Tours_-_01_-_Enthusiast.mp3",
                                        "200", "EDM" },
                        { "Raga Bhairavi", "Pandit Ravi Shankar inspired", "Hindi",
                                        "https://files.freemusicarchive.org/storage-freemusicarchive-org/music/ccCommunity/Chad_Crouch/Arps/Chad_Crouch_-_Algorithms.mp3",
                                        "210", "Classical" },
                        { "Neon Nights", "Synth Pop", "English",
                                        "https://files.freemusicarchive.org/storage-freemusicarchive-org/music/no_curator/Scott_Holmes/Inspiring__Upbeat_Music/Scott_Holmes_-_04_-_Upbeat_Party.mp3",
                                        "190", "Pop" }
        };
                ...
                for (int i = 0; i < FEATURED_SONGS.length; i++) {
                        ...
                        songs.add(new Song(s[0], s[1], "Premium Collection", Integer.parseInt(s[4]),
                                        ...
                                        "https://images.unsplash.com/photo-"
                                                        + (1500000000000L + random.nextInt(1000000)) + "?w=400",
                                        s[5] + " (" + s[2] + ")", "premium-" + i));
                }
        ...
        private Song createSong(String[] titles, String[] artists, String language, String id) {
                ...
                Song song = new Song(title + " #" + (random.nextInt(1000)), artist, language + " Album Hit", duration,
                                audioUrl,
                                imageUrl, genre, id);
                song.setLyrics("[00:00] Play " + title + " by " + artist + "\n" +
                                "[00:10] Verse 1: Riding through the " + language + " streets\n" +
                                "[00:20] Feel the rhythm, hear the beats\n" +
                                "[00:30] Chorus: M4Hub melody taking control\n" +
                                "[00:40] Deep inside your heart and soul\n" +
                                "[00:50] Verse 2: Language of " + language + " is divine\n" +
                                "[01:00] Everything is feeling mighty fine\n" +
                                "[01:10] (Guitar Solo)\n" +
                                "[01:30] Bridge: Don't let the music stop\n" +
                                "[01:40] Take it all the way to the top\n" +
                                "[01:50] Outro: M4Hub vibes forever...");
                return song;
        }
