...
import { ScrollView, View, TouchableOpacity, Image, ActivityIndicator, Linking, Text, TextInput, StyleSheet, RefreshControl } from 'react-native';
...
export default function NewsScreen() {
    ...
    const restArticles = filteredArticles.slice(1, -5);
